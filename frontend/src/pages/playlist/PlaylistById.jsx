...
const PlaylistById = () => {
  ...
  // State to store playlist details
  const [playList, setPlaylist] = useState(null);

  // State to store videos inside playlist
  ...
  // Fetch playlist by ID from backend
  const playListById = async () => {
    try {
      ...
      // Extract and store videos separately
  ...
  // Navigate to update playlist page
  const handleClick = () => {
    navigate(`/playlist/update/${id}`);
  };

  // Placeholder function for adding video
  const handleaddVideo = () => {
    // You can navigate to add-video route or open modal here
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white p-6">
      ...
      {/* Show playlist only when data is loaded */}
      {playList ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {videos.map((video) => (
              ...
              >
                ...
                {/* Add Video Button (currently placeholder) */}
                <button
