...
const UpdateTweet = () => {
  ...
  // State to store updated tweet content
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send PATCH request to update tweet content
      const response = await api.patch(
        `/tweets/${id}`,
        { content: updateTweet }, // Request body
      ...
      // Redirect to tweet detail page after successful update
      navigate(`/tweets/${id}`);
    } catch (error) {
